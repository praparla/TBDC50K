...
- [ ] **Fix Pace Calculator "Countdown" label mismatch** — The pace note says "Set a start time in the Countdown section" but the actual section is called "Race Day Clock". Update the text to match or make the section name linkable. (UX papercut discovered 2026-03-26)
