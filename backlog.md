...
- [ ] **Consolidate "Calorie Tracker" with food sections** — Calorie Tracker already references both Mandatory Food and Food Log. Consider merging into the food consolidation (above) so there's one "Food & Nutrition" section with sub-tabs: Mandatory, Log, Calories. Reduces section count by 2.
