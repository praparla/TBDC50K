...
- [ ] **Merge "Block Parties" into "Party Spots"** — Both are party-related sections. Block Parties shows community-organized parties; Party Spots shows backend-driven parties. Since Block Parties data is also loaded from a JSON file, these could be a single "Parties" section with a "Community" vs "Hosted" distinction. Reduces section count by 1.
